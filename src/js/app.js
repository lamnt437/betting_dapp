App = {
  ...
  initContract: function() {
    ...
    App.contract = bettingContract.at("0x5287d4e68a69284d599dc17a33789f955677cd7b") // 10 slots
    // App.contract = bettingContract.at("0xdcd9bf7da671017150d75c1ac47b316def610776") // 4 slots
  ...
  updateState: function() {
    ...
    let coinbase = web3.eth.coinbase; //metamask account
    web3.eth.getBalance(coinbase, function (err, result) {
      if (!err) {
        $("#coinbase").text(coinbase + " (" + web3.fromWei(result.toNumber()) + " ETH)"); //convert to eth
      }
